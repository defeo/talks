...
\begin{frame}{Parameter sets}
  ...
  \begin{tabular}{c || c c c}
    ...
    \hline\hline
    \texttt{SIKEp434} & $2^{216}3^{137}-1$ & 433.13 & NIST 1\\
    \texttt{SIKEp503} & $2^{250}3^{159}-1$ & 502.01 & NIST 2\\
    \texttt{SIKEp610} & $2^{305}3^{192}-1$ & 609.31 & NIST 3\\
    \texttt{SIKEp751} & $2^{372}3^{239}-1$ & 750.81 & NIST 5\\
    \hline
  \end{tabular}
\end{frame}
...
\begin{frame}{Key compression}
  \vfill
  \centering
  \begin{tabular}{l || c c | c c }
    \hline
    Scheme & Public key & ciphertext & Encaps & Decaps \\
           & \multicolumn{2}{c|}{\small bytes} & \multicolumn{2}{c}{\small $10^3$ cycles (\texttt{x86\_64} asm)} \\
    \hline\hline
    \texttt{SIKEp434} & 330 & 346 & 9,681 & 10,343 \\
    \texttt{SIKEp434\_compressed} & 197 & 236 & 15,120 & 11,077 \\
    \texttt{SIKEp503} & 378 & 402 & 13,554 & 14,415 \\
    \texttt{SIKEp503\_compressed} & 225 & 280 & 21,190 & 15,733 \\
    \texttt{SIKEp610} & 462 & 486 & 27,254 & 27,445 \\
    \texttt{SIKEp610\_compressed} & 274 & 336 & 37,470 & 29,216 \\
    \texttt{SIKEp751} & 564 & 596 & 40,703 & 43,851 \\
    \texttt{SIKEp751\_compressed} & 335 & 410 & 63,254 & 46,606 \\
    \hline
  \end{tabular}
...
\begin{frame}{Additional implementations}
  ...
  \begin{tabular}{c || c || c c | c c}
    ...
    & Scheme & \multicolumn{2}{c|}{Cortex M4 (ARMv7)} & \multicolumn{2}{c}{Cortex A72 (ARMv8)} \\
