...
\date[\url{https://defeo.lu/docet}]{June 4, 2019, CTCrypt, Svetlogorsk\\[1em]
...
\frame[plain]{
  \begin{tikzpicture}[remember picture,overlay]
    \node[at=(current page.center), opacity=0.6] {
      \includegraphics[width=1\paperwidth]{2019-06-04-ctcrypt.jpg}
    };
  \end{tikzpicture}
  \vspace{-1cm}
  ...
  {\titlepage}
  \begin{center}
    Slides online at~~~~~\textcolor{blue!80!black}{\href{https://defeo.lu/docet/}{https://defeo.lu/docet/}}
  \end{center}
}
...
\begin{frame}{Rejection sampling}
  \begin{columns}
    ...
    \begin{column}{0.45\textwidth}
      \centering
      \begin{tikzpicture}[yscale=0.3,xscale=0.2]
        \draw (-4.3,3) node{$+(\delta+1)B$} (-4.3,-3) node{$-(\delta+1)B$};
        \draw (0,0) -- (18,0);
        ...
        \draw (-2.5,-14.5) node{$+\delta B$} (-2.5,-19.5) node{$-\delta B$};
        \draw (0,-17) -- (18,-17);
