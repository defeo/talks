...
\author{Luca De Feo}
\date[September 11, 2017 --- APP (Lille)]{September 11, 2017, Arithmétique en Plat Pays, Lille}
\institute[UVSQ \& INRIA]{Université de Versailles \& Inria, Université Paris-Saclay}

\begin{document}

\frame[plain]{
  \begin{tikzpicture}[overlay,/lattice={3}{0.6}{1.2}{2.1},opacity=0.5]
