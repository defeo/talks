...
\author{Luca De Feo}
\date[September 23, 2024, Roma 3]{September 23, 2024\\
  Seminario di Crittografia, Università Roma 3, Italy}
...
\begin{frame}{The \textit{smooth} criminals}
  ...
  \begin{columns}
    \begin{column}{0.7\textwidth}
      ...
      \item[2011] SIDH key exchange\\ {\small(Jao, D.)}
...
\begin{frame}{SQIsign \small(identification scheme)}
  ...
  \begin{tikzpicture}[very thick]
    ...
    \uncover<2->{
      \fill (6,3) node(COM){} circle (4pt);
      \draw[dashed,->>>>] (E0) edge node[sloped,above] {commitment} (COM);
    }

    \uncover<3->{
      \fill (10,0) node(CH){} circle (4pt);
    }
    \uncover<3,6->{
