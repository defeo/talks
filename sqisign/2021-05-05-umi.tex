...
\title{The effective Deuring correspondence}
\subtitle{the key to the next generation of isogeny based cryptography?}
\author{Luca De Feo}
\date[May 5, 2021, UMI 2021]{May 5, 2021\\
  Seminario UMI Crittografia e Codici}
      ...
      \begin{tikzpicture}
        \begin{scope}
          ...
          \uncover<2->{
            ...
            node[yshift=1em,rotate=360/\crater*(7+1)/2-90]{discrete log} (360/\crater*7 : \diam-4);
          }
        \end{scope}  
      \end{tikzpicture} 
    \end{column}
...
\begin{frame}{Reduction at $\p$}
  ...
  \emph{Rostovtsev--Stolbunov} '06, \emph{CSIDH} '18, \dots
\end{frame}
