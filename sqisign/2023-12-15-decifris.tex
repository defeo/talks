...
\author{Luca De Feo}
\date[December 15, 2023, CIFRIS23]{December 15, 2023, CIFRIS23}
...
\begin{frame}{Isogenies = finite subgroups}
  \large
  Let $K ⊂ E$ finite, there exists a unique (separable) isogeny
  \[\emph{\phi : E → E/K}\]
  up to post-composition by an isomorphism.

  \vspace{2em}

  $O(N)$ cyclic subgroups s.t. $\#K = N \quad\to\quad O(N)$ distinct isogenies
\end{frame}
